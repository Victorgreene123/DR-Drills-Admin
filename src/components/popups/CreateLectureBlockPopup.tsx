...
const CreateLectureBlockPopup: React.FC<
{
    onClose: () => void;
}
> = ({ onClose }) => {
        ...
        useEffect(() => {
         ...
         const handleSubmit = async () => {
            ...
            try {
              ...
              if (response.ok) {
                console.log('Lecture Block created successfully');
                onClose();
        
              }
            } catch (error) {
              console.error('Error creating Lecture Block:', error);
            }
            finally{
              setLoading(false);
            }
    ...
    return(
		<PopUpContainer title="Create New Lecture Block" onClose={() => onClose()}>
<div className=" ">
              <div className="space-y-3">
                ...
                <div className="relative p-2 h-[56px]">
                  <textarea
                    ...
                    placeholder="Give your lecture block a title"
                    style={{ resize: "none" }}
                    value={title}
                    onChange={
                      (e) => {
                ...
                <div className="relative p-2 h-[56px]">
                  <textarea
                    className="w-full absolute top-0 left-0 border-[1px] border-[#C3C6CF] outline-none rounded h-full px-2 py-1 text-xs"
                    placeholder="Give your lecture block a description"
                    style={{ resize: "none" }}
                    value={description}
                    onChange={
                      (e) => {
                      ...
                      <ul className="absolute left-0 top-full bg-white border border-[#C3C6CF] rounded shadow-lg w-full z-10 max-h-32 overflow-y-auto">
                          ...
                          >
                            ...
                            {/* Add Lectures Section  */}
                                    ...
                                    <div className="w-1/2 space-y-1">
                                      ...
                                      <p className="text-black font-[400] text-[10px]">Attach a lecture to this lecture block</p>
                                      <div className="w-full relative border border-[#C3C6CF] rounded-[6px] text-xs min-h-[28px]">
                                        <div
                        ...
                        <div className="flex justify-end mt-4">
                          <button
                            ...
                            disabled={loading}
                          >
                            {loading ? <FaSpinner className="animate-spin text-lg" />: 'Create Lecture Block'}
                          </button>
                        </div>
...
export default CreateLectureBlockPopup;